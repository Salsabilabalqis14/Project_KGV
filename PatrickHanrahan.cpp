...
float color2[] = { 0.5f, 0.0f, 0.0f, 1.0f };
float color3[] = { 0.2f, 0.0f, 0.0f, 1.0f };
float color4[] = { 0.0f, 1.0f, 0.0f, 1.0f };
float color5[] = { 0.0f, 0.5f, 0.0f, 1.0f };
float color6[] = { 0.0f, 0.2f, 0.0f, 1.0f };
float color7[] = { 0.0f, 0.0f, 1.0f, 1.0f };
float color8[] = { 0.0f, 0.0f, 0.5f, 1.0f };

float scale = 0.5f;
float currentTime = 0.0f;
GLint scaleLoc, color1Loc, color2Loc, color3Loc, color4Loc, color5Loc, color6Loc, color7Loc, color8Loc;
...
int main(void)
{
    ...
    window = glfwCreateWindow(640, 640, "Project UTS: Patrick Hanrahan", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
        return -1;
    ...
    int triangle = 8;
    float angle = 3.1415926 * 2.0f / triangle;
    float radius = 1.0f;
    float vertices[18];
    ...
    for (int i = 0; i <= triangle; i++) {
        vertices[a] = radius * sin(angle * i);       // nilai x
        vertices[a + 1] = -radius * cos(angle * i);  // nilai y
        a = a + 2;
    }
